 ...
 */
package io.androidpoet.drafterdemo.desktop
  ...
  ChartEntry("Bullet") {
    BulletChart(
      renderer = BulletChartRenderer(
        BulletData(
          metrics = listOf(
            BulletMetric("Revenue", value = 72f, target = 80f, ranges = listOf(40f, 65f, 100f), color = palette[7]),
            BulletMetric("Profit", value = 55f, target = 50f, ranges = listOf(30f, 60f, 90f), color = palette[1]),
            BulletMetric("Users", value = 88f, target = 75f, ranges = listOf(50f, 70f, 100f), color = palette[2]),
          ),
        ),
      ),
      modifier = chartModifier(),
  ...
  ChartEntry("Box Plot") {
    BoxPlotChart(
      renderer = BoxPlotChartRenderer(
        BoxPlotData(
          groups = listOf(
            BoxGroup("A", min = 5f, q1 = 18f, median = 28f, q3 = 38f, max = 52f, color = palette[2]),
            BoxGroup("B", min = 10f, q1 = 22f, median = 30f, q3 = 41f, max = 48f, color = palette[0]),
            BoxGroup("C", min = 8f, q1 = 15f, median = 24f, q3 = 33f, max = 44f, color = palette[1]),
            BoxGroup("D", min = 12f, q1 = 26f, median = 35f, q3 = 45f, max = 58f, color = palette[4]),
          ),
        ),
      ),
      modifier = chartModifier(),
...
fun main() = application {
  Window(
    ...
    state = rememberWindowState(width = 1280.dp, height = 920.dp),
    title = "Drafter Desktop Demo",
  ) {
