package io.androidpoet.drafter
...
object ChartThemeManager {
    enum class ColorTheme {
        MATERIAL, MODERN, NATURE, PROFESSIONAL
    }

    // Define palettes first
    private val palettes = mapOf(
        ColorTheme.MATERIAL to listOf(
        ...
        ColorTheme.PROFESSIONAL to listOf(
            Color(0xFF5C6BC0),  // Indigo
            Color(0xFF8D6E63),  // Brown
            Color(0xFF26A69A),  // Teal
    ...
    private val githubColors = listOf(
